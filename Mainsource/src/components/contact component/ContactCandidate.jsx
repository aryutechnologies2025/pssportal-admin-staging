              ...
              <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center">
                <div className="relative bg-white w-[95%] md:w-[500px] rounded-xl shadow-lg p-6">
                  ...
                  <div className="space-y-2 text-sm">
                    <p>
                      <b>Name:</b> {Capitalise(viewContact.name || "-")}
                    </p>
                    <p>
                      <b>Email:</b> {viewContact.email || "-"}
                    </p>
                    <p>
                      <b>Phone:</b> {viewContact.phone_number || "-"}
                    </p>
                    <p>
                      <b>Gender:</b> {Capitalise(viewContact.gender || "-")}
                    </p>
                    <p>
                      <b>Subject:</b> {Capitalise(viewContact.subject || "-")}
                    </p>
                    <p>
                      <b>Created Date:</b>{" "}
