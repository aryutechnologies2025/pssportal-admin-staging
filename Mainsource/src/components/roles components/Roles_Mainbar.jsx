...
const Roles_Mainbar = () => {
  ...
  const openEditModal = (id, role_name, status, department_id) => {
    setEditingRoleId(id);
    setRoleDetails({
      role_name,
  ...
  const closeEditModal = () => {
    ...
    setRoleDetails({ role_name: "", status: "", department_id: "" });
    setErrors({});
        ...
        <div className="flex justify-center gap-3">
          ...
          <TfiPencilAlt
            onClick={() => {
              ...
              openEditModal(row.id, row.role_name, row.status, row.department_id);
                  ...
                  <div className="px-5 lg:px-14  py-2 md:py-10 text-[#4A4A4A] font-medium">
                    ...
                    <div className="flex justify-end gap-2 mt-5 md:mt-14">
                      ...
                      <button disabled={submitting} onClick={handlesubmit}
                        className="bg-[#005AEF] hover:bg-[#2879FF] text-white px-4 md:px-5 py-2 font-semibold rounded-lg disabled:opacity-50 transition-all duration-200">
                      ...
                      <div className="bg-white rounded-xl w-full">
                        ...
                        <div className="flex justify-end gap-2 mt-14">
                          ...
                          <button onClick={handleSave}
                            className="hover:bg-[#1ea600] hover:text-white border border-[#7C7C7C] text-base md:text-xl text-[#7C7C7C] px-4 md:px-5 py-2 font-medium rounded-[10px]">
                            Update
                          </button>
                        </div>
                      </div>
