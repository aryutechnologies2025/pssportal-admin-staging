      ...
      <div>
        ...
        <div className="flex flex-col md:flex-row gap-5 justify-between mt-8">
          ...
          <button
            ...
            className="bg-blue-500 px-3 py-1 font-medium text-sm w-fit text-white rounded-full"
          >
            {" "}
            + Add Transaction
          </button>
          ...
          <div className="fixed inset-0 min-h-screen bg-black/10 backdrop-blur-sm bg-opacity-50 z-50">
            ...
            >
              ...
              <div className="flex  flex-col gap-3 mt-8">
                ...
                {/* gst/tax*/}
                <div className="flex flex-col lg:flex-row gap-1 justify-between">
                  <label className="font-medium text-sm" htmlFor="gst/tax">
                    GST/TAX
                  </label>
...
export default Expense_History_Mainbar;
